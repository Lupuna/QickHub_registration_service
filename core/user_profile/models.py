...
class Reminders(models.Model):
    ...
    def __str__(self):
        return f'id: {self.id}  |  Days before start task: {self.days_before_start_task}  |  Exact time of day before task start: {self.exact_time_of_day_before_start_task}  |  Time before deadline: {self.time_before_deadline}  |  Remind about expired deadline in: {self.remind_about_expire_in}'
